function productGallery() {
    ...
    e.sync(t), e.mount(), t.mount(), e.on("inactive", function(e) {
    ...
    const i = /Apple/i,
        s = /Safari/i;
    i.test(navigator.vendor) && s.test(navigator.userAgent) && document.querySelector("html").classList.add("is-safari")
}
...
function isStorageSupported(e) {
    ...
    var t = "beyours:test";
    let i;
    "session" === e && (i = window.sessionStorage), "local" === e && (i = window.localStorage);
    try {
...
function setScrollbarWidth() {
    var e, t;
    checkScrollbar() && ((e = document.createElement("span")).className = "modal-scrollbar-measure", document.body.appendChild(e), t = e.getBoundingClientRect().width - e.clientWidth, document.body.removeChild(e), document.documentElement.style.setProperty("--scrollbar-width", t + "px"))
}

function setHeaderHeight() {
    var e = document.getElementById("shopify-section-header");
    e && document.documentElement.style.setProperty("--header-height", parseInt(e.getBoundingClientRect().bottom) + "px")
}
...
window.theme = window.theme || {}, theme.config = {
        ...
        formatMoney: function(e, t) {
            ...
            function n(e, t, i, s) {
                return i = i || ",", s = s || ".", isNaN(e) || null === e ? 0 : (t = (e = (e / 100).toFixed(t)).split("."))[0].replace(/(\d)(?=(\d\d\d)+(?!\d))/g, "$1" + i) + (t[1] ? s + t[1] : "")
            }
        ...
        new IntersectionObserver((e, t) => {
            e.forEach(e => {
                e.isIntersecting && "function" == typeof i.callback && (i.callback(), t.unobserve(e.target))
            })
        }, {
    ...
    function() {
        ...
        function t() {
            ...
            (/iPad|iPhone|iPod/.test(e) || "MacIntel" === e && 1 < navigator.maxTouchPoints) && document.documentElement.style.setProperty("--viewport-height", window.innerHeight + "px"), setHeaderHeight()
        }
        if (theme.config.mqlSmall = e.matches, e.onchange = e => {
            ...
            }), window.addEventListener("resize", t), window.addEventListener("DOMContentLoaded", t), null !== document.body.getAttribute("data-page-rendering")) {
            const i = new IntersectionObserver((e, t) => {
                e.forEach(e => {
                    var t = e.target;
                    0 == e.intersectionRatio || t.markedVisible || (t.attributeStyleMap && t.attributeStyleMap.set("content-visibility", "visible"), t.markedVisible = !0)
                })
            }, {
                rootMargin: "50px 0px 100px 0px"
            });
            document.querySelectorAll(".shopify-section + .shopify-section").forEach(e => {
                i.observe(e)
            })
        }
    }(),
...
function trapFocus(t, e = t) {
    ...
    removeTrapFocus(), trapFocusHandlers.focusin = e => {
        e.target !== t && e.target !== n && e.target !== s || document.addEventListener("keydown", trapFocusHandlers.keydown)
    }, trapFocusHandlers.focusout = function() {
        document.removeEventListener("keydown", trapFocusHandlers.keydown)
    }, trapFocusHandlers.keydown = function(e) {
        "TAB" === (e.code || e.key).toUpperCase() && (e.target !== n || e.shiftKey || (e.preventDefault(), s.focus()), e.target === t || e.target === s) && e.shiftKey && (e.preventDefault(), n.focus())
    }, document.addEventListener("focusout", trapFocusHandlers.focusout), document.addEventListener("focusin", trapFocusHandlers.focusin), e && e.focus()
}
try {
...
function focusVisiblePolyfill() {
    const t = ["ARROWUP", "ARROWDOWN", "ARROWLEFT", "ARROWRIGHT", "TAB", "ENTER", "SPACE", "ESCAPE", "HOME", "END", "PAGEUP", "PAGEDOWN"];
    let e = null,
        i = null;
...
function onKeyUpEscape(e) {
    var t;
    "ESCAPE" === (e.code || e.key).toUpperCase() && (e = e.target.closest("details[open]")) && (t = e.querySelector("summary"), e.removeAttribute("open"), t.setAttribute("aria-expanded", !1), t.focus())
}

function filterShopifyEvent(e, t, i) {
    let s = !1;
    e.type.includes("shopify:section") ? t.hasAttribute("data-section-id") && t.getAttribute("data-section-id") === e.detail.sectionId && (s = !0) : e.type.includes("shopify:block") && e.target === t && (s = !0), s && i(e)
}
...
const serializeForm = e => {
    ...
    for (const n of i.keys()) {
        var s = /(?:^(properties\[))(.*?)(?:\]$)/;
        s.test(n) ? (t.properties = t.properties || {}, t.properties[s.exec(n)[2]] = i.get(n)) : t[n] = i.get(n)
    }
...
void 0 === window.Shopify && (window.Shopify = {}), Shopify.bind = function(e, t) {
    ...
    for (const a in s) {
        ...
        r.setAttribute("type", "hidden"), r.setAttribute("name", a), r.setAttribute("value", s[a]), n.appendChild(r)
    }
    ...
    for (const a in s)
        for (const o in s[a])
            for (const l in s[a][o]) {
                var r = document.createElement("input");
                r.setAttribute("type", "hidden"), r.setAttribute("name", `${a}[${o}][${l}]`), r.setAttribute("value", s[a][o][l]), n.appendChild(r)
            }
    document.body.appendChild(n), n.submit(), document.body.removeChild(n)
}, Shopify.CountryProvinceSelector = function(e, t, i) {
    this.countryEl = document.getElementById(e), this.provinceEl = document.getElementById(t), this.provinceContainer = document.getElementById(i.hideElement || t), Shopify.addListener(this.countryEl, "change", Shopify.bind(this.countryHandler, this)), this.initCountry(), this.initProvince()
    ...
    initProvince: function() {
        ...
        e && 0 < this.provinceEl.options.length && Shopify.setSelectorByValue(this.provinceEl, e)
    },
    countryHandler: function(e) {
        var t = (s = this.countryEl.options[this.countryEl.selectedIndex]).getAttribute("data-provinces"),
            i = JSON.parse(t);
        if (this.clearOptions(this.provinceEl), i && 0 == i.length) this.provinceContainer.style.display = "none";
        else {
            for (var s, n = 0; n < i.length; n++)(s = document.createElement("option")).value = i[n][0], s.innerHTML = i[n][1], this.provinceEl.appendChild(s);
...
class MenuDrawer extends HTMLElement {
    constructor(e) {
        super(), this.classes = e ? e.classes : {
    ...
    onKeyUp(e) {
        var t;
        "ESCAPE" === (e.code || e.key).toUpperCase() && (t = e.target.closest("details[open]")) && (t === this.mainDetailsToggle ? this.closeMenuDrawer(e, this.mainDetailsToggle.querySelector("summary")) : this.closeSubmenu(t))
    }
    onSummaryClick(e) {
        ...
        function r() {
            trapFocus(t.nextElementSibling, i.querySelector("button")), t.nextElementSibling.removeEventListener("transitionend", r)
        }
        i === this.mainDetailsToggle ? (s && e.preventDefault(), s ? this.closeMenuDrawer(e, t) : this.openMenuDrawer(t)) : setTimeout(() => {
            i.classList.add("menu-opening"), t.setAttribute("aria-expanded", !0), !n || n.matches ? r() : t.nextElementSibling.addEventListener("transitionend", r)
        }, 100)
    }
    openMenuDrawer(e) {
        setHeaderHeight(), setScrollbarWidth(), setTimeout(() => {
            this.mainDetailsToggle.classList.add("menu-opening")
        }), e.setAttribute("aria-expanded", !0), trapFocus(this.mainDetailsToggle, e), setTimeout(() => {
            ...
            this.classes.open.includes("mini-cart") && document.getElementById("cart").addEventListener("submit", () => {
                var e = document.getElementById("cart"),
                    e = JSON.parse(e.getAttribute("data-ga4-onsubmit"));
                dataLayer.push(e)
            })
        }, 1e3), document.body.classList.add(this.classes.opening), this.openAnimation()
    }
    closeMenuDrawer(e, t = !1) {
        void 0 !== e && (this.mainDetailsToggle.querySelectorAll("details").forEach(e => {
    ...
    openAnimation() {
        let t;
        const i = e => {
            e - (t = void 0 === t ? e : t) < 400 ? window.requestAnimationFrame(i) : (document.body.classList.remove(this.classes.opening), document.body.classList.add(this.classes.open))
        };
    ...
    closeAnimation(t) {
        let i;
        const s = e => {
            e - (i = void 0 === i ? e : i) < 400 ? window.requestAnimationFrame(s) : (t === this.mainDetailsToggle && (document.body.classList.remove(this.classes.closing), t.classList.remove("menu-closing")), t.removeAttribute("open"), t.closest("details[open]") && trapFocus(t.closest("details[open]"), t.querySelector("summary")))
        };
...
class ModalDialog extends HTMLElement {
    constructor() {
        super(), this.querySelector('[id^="ModalClose-"]').addEventListener("click", this.hide.bind(this)), this.addEventListener("keyup", e => {
            "ESCAPE" === (e.code || e.key).toUpperCase() && this.hide()
        }), this.classList.contains("media-modal") ? this.addEventListener("pointerup", e => {
...
class DeferredMedia extends HTMLElement {
    ...
    loadContent() {
        var e;
        window.pauseAllMedia(), this.getAttribute("loaded") || ((e = document.createElement("div")).appendChild(this.querySelector("template").content.firstElementChild.cloneNode(!0)), (e.querySelector("video-section") ? this.appendChild(e) : (this.setAttribute("loaded", !0), this.appendChild(e.querySelector("video, model-viewer, iframe")))).focus())
    }
}
...
class SliderComponent extends HTMLElement {
    ...
    initPages() {
        this.sliderItemsToShow = Array.from(this.sliderItems).filter(e => 0 < e.clientWidth), this.sliderItemsToShow.length < 2 || (this.sliderItemOffset = this.sliderItemsToShow[1].offsetLeft - this.sliderItemsToShow[0].offsetLeft, this.slidesPerPage = Math.floor(this.slider.clientWidth / this.sliderItemOffset), this.totalPages = this.sliderItemsToShow.length - this.slidesPerPage + 1, this.update())
    }
    resetPages() {
    ...
    update() {
        ...
        })), 1 === this.currentPage && this.currentPage === this.totalPages ? this.classList.add("slider--no-buttons") : this.classList.remove("slider--no-buttons"), this.enableSliderLooping || (t = 1 === this.currentPage, e = this.currentPage === this.sliderItemsToShow.length, t || this.isSlideVisible(this.sliderItemsToShow[0]) ? this.prevButton.setAttribute("disabled", "disabled") : this.prevButton.removeAttribute("disabled"), e || this.isSlideVisible(this.sliderItemsToShow[this.sliderItemsToShow.length - 1]) ? this.nextButton.setAttribute("disabled", "disabled") : this.nextButton.removeAttribute("disabled"))
    }
    isSlideVisible(e, t = 0) {
        t = this.slider.clientWidth + this.slider.scrollLeft - t;
        return e.offsetLeft + e.clientWidth <= t && e.offsetLeft >= this.slider.scrollLeft
    }
    onButtonClick(e) {
        e.preventDefault();
        var t = e.currentTarget.dataset.step || 1;
        this.slideScrollPosition = "next" === e.currentTarget.name ? this.slider.scrollLeft + t * this.sliderItemOffset : this.slider.scrollLeft - t * this.sliderItemOffset, this.slideScrollPosition = theme.config.rtl ? -1 * this.slideScrollPosition : this.slideScrollPosition, this.slider.scrollTo({
...
class ThumbnailSlider extends SliderComponent {
    ...
    init() {
        super.init();
        var e = this.querySelectorAll(".thumbnail-list_item--variant:not(.is-active)");
        this.slider.dataset.mediaCount = this.sliderItems.length - e.length, this.querySelector("[data-gang-option]") && (e = this.querySelectorAll("[data-gang-option]:not(.gang__active)"), this.slider.dataset.mediaCount = this.sliderItems.length - e.length), this.slider.dataset.mediaCount < 2 && this.classList.add("hidden")
    }
}
...
class QuoteSlider extends SliderComponent {
    ...
    update() {
        super.update(), this.currentPageElement && this.pageTotalElement && (this.sliderItems.forEach(e => {
...
class ProductGallery extends SliderComponent {
    ...
    init() {
        ...
        e && this.querySelector("[data-gang-option]") && (this.querySelectorAll(".product__media-item.gang__active").length < 2 ? e.classList.add("hidden") : e.classList.remove("hidden")), this.cursor = this.querySelector(".gallery-cursor"), this.cursor && ((e = this.querySelectorAll(".product__modal-opener--image")).forEach(e => e.addEventListener("mousemove", this.onMoveHandler.bind(this))), e.forEach(e => e.addEventListener("mouseenter", this.onEnterHandler.bind(this))), e.forEach(e => e.addEventListener("mouseleave", this.onLeaveHandler.bind(this))))
    }
    onMoveHandler(e) {
        this.cursor.style.left = e.clientX - 32 + "px", this.cursor.style.top = e.clientY - 32 + "px"
    }
    onEnterHandler() {
    ...
    update() {
        var e;
        super.update(), this.currentPageElement && this.pageTotalElement && (e = this.sliderItemsToShow[this.currentPage - 1]) && this.slider.style.setProperty("--force-image-ratio-percent", e.querySelector(".media").style.getPropertyValue("--image-ratio-percent"))
    }
    goToFirstSlide() {
...
class VariantSelects extends HTMLElement {
    ...
    onVariantChange(e) {
        this.updateOptions(), this.updateMasterId(), this.toggleAddButton(!0, "", !1), this.updatePickupAvailability(), this.removeErrorMessage(), this.validateGang(), this.currentVariant ? (this.gangOption ? this.updateGangMedia() : this.updateMedia(), this.updateURL(), this.updateVariantInput(), this.renderProductInfo()) : (this.toggleAddButton(!0, "", !0), this.setUnavailable()), this.handleStickyCart(e.target)
    }
    handleStickyCart(t) {
        var e;
        document.getElementById("sticky-cart-" + this.dataset.section) && (e = t.getAttribute("name"), document.querySelectorAll(`variant-radios[data-section="${this.dataset.section}"] [name="${e}"], variant-selects[data-section="${this.dataset.section}"] [name="${e}"]`).forEach(e => {
            "INPUT" === e.tagName ? e.checked = e.value === t.value : e.value = t.value
    ...
    validateGang() {
        var e = document.querySelector(`#shopify-section-${this.dataset.section} [data-gang-option]`);
        e && (this.gangOption = e.dataset.gangOption)
    }
    updateGangMedia() {
        if (this.gangOption) {
            var e = this.querySelector('.variant-input-wrapper[data-option-slug="' + this.gangOption + '"]');
            if (e ? this.gangIndex = e.dataset.optionIndex : this.gangOption = null, this.currentVariant) {
    ...
    updateVariantInput() {
        document.querySelectorAll(`#product-form-${this.dataset.section}, #product-form-installment, #product-form-${this.dataset.section}--alt`).forEach(e => {
    ...
    renderProductInfo() {
        fetch(`${this.dataset.url}?variant=${this.currentVariant.id}&section_id=` + this.dataset.section).then(e => e.text()).then(e => {
            this.updateSKU(e), this.updatePrice(e), this.updatePriceAlt(e), this.updateColorName(e), this.updateInventoryStatus(e), this.updateGallery(e), this.currentVariant && this.toggleAddButton(!this.currentVariant.available, variantStrings.soldOut)
        }).catch(e => {
            console.error(e)
        })
    }
    updateSKU(e) {
        ...
        e && i && (i.innerHTML = e.innerHTML), i && i.classList.remove("visibility-hidden")
    }
    updatePrice(e) {
    ...
    updateGallery(e) {
        var t = "product-gallery-" + this.dataset.section,
            ...
            i = document.getElementById(t),
            e = e.getElementById(t);
        e && i && (i.innerHTML = e.innerHTML), i && i.classList.remove("visibility-hidden"), productGallery()
    }
    updatePriceAlt(e) {
    ...
    toggleAddButton(t = !0, i, e) {
        document.querySelectorAll(`#product-form-${this.dataset.section}, #product-form-${this.dataset.section}--alt`).forEach(e => {
            e = e.querySelector('[name="add"]');
            e && (t ? (e.setAttribute("disabled", !0), i && (e.textContent = i)) : (e.removeAttribute("disabled"), e.textContent = "true" === e.dataset.preOrder ? variantStrings.preOrder : variantStrings.addToCart))
        })
    }
    setUnavailable() {
        document.querySelectorAll(`#product-form-${this.dataset.section}, #product-form-${this.dataset.section}--alt`).forEach(e => {
            var e = e.querySelector('[name="add"]');
            e && (e.textContent = variantStrings.unavailable, (e = document.getElementById("price-" + this.dataset.section)) && e.classList.add("visibility-hidden"), (e = document.getElementById(`price-${this.dataset.section}--alt`)) && e.classList.add("visibility-hidden"), e = document.getElementById("inventory-" + this.dataset.section)) && e.classList.add("visibility-hidden")
        })
    }
    getVariantData() {
...
class ProductForm extends HTMLElement {
    ...
    onSubmitHandler(e) {
        if (!document.body.classList.contains("template-cart") && shopSettings.cartDrawer) {
            ...
            var t;
            i.classList.contains("loading") || (this.handleErrorMessage(), i.setAttribute("aria-disabled", !0), i.classList.add("loading"), (e = fetchConfig("javascript")).headers["X-Requested-With"] = "XMLHttpRequest", delete e.headers["Content-Type"], t = new FormData(this.form), this.miniCart && t.append("sections", this.miniCart.getSectionsToRender().map(e => e.id)), t.append("sections_url", window.location.pathname), e.body = t, fetch("" + routes.cart_add_url, e).then(e => e.json()).then(e => {
                e.status ? this.handleErrorMessage(e.description) : (this.miniCart && this.miniCart.renderContents(e), dataLayer && dataLayer.push({
                    event: "addToCart",
                    ecommerce: {
                        currencyCode: "SEK",
                        add: {
    ...
    handleErrorMessage(e = !1) {
        this.errorMessageWrapper = this.errorMessageWrapper || this.querySelector(".product-form__error-message-wrapper"), this.errorMessageWrapper ? (this.errorMessage = this.errorMessage || this.errorMessageWrapper.querySelector(".product-form__error-message"), this.errorMessageWrapper.toggleAttribute("hidden", !e), e && (this.errorMessage.textContent = e)) : e && alert(e)
    }
}
...
class FormState extends HTMLElement {
    constructor() {
        super(), this.formInputs = this.querySelectorAll("input,select,textarea"), this.form = this.querySelector("form"), this.formInputs.forEach(e => {
            e.addEventListener("input", this.onInputChange.bind(this)), e.addEventListener("blur", this.onInputChange.bind(this))
    ...
    handleInputCheck(e) {
        return !e.classList.contains("required") || (0 === e.value.length || e.value === e.dataset.empty ? (e.classList.remove("valid"), e.classList.add("invalid"), !1) : (e.classList.remove("invalid"), e.classList.add("valid"), !0))
    }
}
...
class ListMenuHover extends HTMLElement {
    ...
    open(e) {
        let t = "";
        (0 < e.image.length || 0 < e.description.length) && (t = (t = (t = (t = (t += `<a href="${e.url}" class="hover-collection${0<e.image.length?"":" hover-collection--no-image"}">`) + '<figure class="hover-collection__image"' + (0 < e.image.length ? `style="background-image:url(${e.image})"` : "") + '></figure><div class="hover-collection__content">') + `<span class="hover-collection__title h4">${e.title}</span>`) + (0 < e.description.length ? `<div class="hover-collection__description">${e.description}</div>` : "")) + "</div></a>"), this.innerHTML = t
    }
    close() {
        this.innerHTML = ""
    }
...
class TransparentHeader extends HTMLElement {
    constructor() {
        super();
        var e = document.getElementById("shopify-section-header");
        e.classList.add("transparent-header"), "true" == this.dataset.showSeparator && e.classList.add("transparent-separator")
    }
}
...
class ColorSwatch extends HTMLElement {
    ...
    onHoverHandler() {
        ...
        null !== e && (e.src = this.dataset.src, e.srcset = this.dataset.srcset, this.activeColorSwatch())
    }
    activeColorSwatch() {
        this.closest(".card__colors").querySelectorAll(".color-swatch").forEach(e => {
...
class AddToCart extends HTMLElement {
    ...
    onClickHandler() {
        var e, t = this.dataset.variantId;
        t && (document.body.classList.contains("template-cart") || !shopSettings.cartDrawer ? Shopify.postLink(routes.cart_add_url, {
            parameters: {
                id: t,
                quantity: 1
            }
        }) : (this.setAttribute("disabled", !0), this.classList.add("loading"), e = this.miniCart ? this.miniCart.getSectionsToRender().map(e => e.id) : [], t = JSON.stringify({
            id: t,
            quantity: 1,
            sections: e,
...
class SlideshowComponent extends HTMLElement {
    ...
    bindEvents() {
        ...
        this.flickityLarge.on("dragMove", (e, t, i) => {
            s = this.flickityLarge.selectedIndex, n = this.getSwipeDirection(i), this.stopPlayer()
        }), this.flickityLarge.on("dragEnd", () => {
            this.flickityLarge.selectedIndex !== s && ("left" === n ? this.flickitySmall.next() : this.flickitySmall.previous())
        })
    }
    stopPlayer() {
    ...
    unload() {
        this.flickitySmall && "function" == typeof this.flickitySmall.destroy && this.flickitySmall.destroy(), this.flickityContent && "function" == typeof this.flickityContent.destroy && this.flickityContent.destroy(), this.flickityLarge && "function" == typeof this.flickityLarge.destroy && this.flickityLarge.destroy()
    }
}
customElements.define("slideshow-component", SlideshowComponent);
class TestimonialsComponent extends HTMLElement {
    constructor() {
        super(), "true" == this.dataset.slider && (this.settings = {
            autorotate: "true" == this.dataset.autorotate,
            autorotateSpeed: parseInt(this.dataset.autorotateSpeed)
    ...
    init() {
        setTimeout(() => {
            this.flickity = new Flickity(this.slider, {
                ...
                friction: .8,
                adaptiveHeight: !0
            }), this.flickityNav.previous(), this.settings.autorotate && this.flickity.pausePlayer(), this.flickity.on("staticClick", (e, t, i, s) => {
...
class TabCollage extends HTMLElement {
    constructor() {
        super(), this.querySelectorAll(".tab-collage__heading").forEach(e => e.addEventListener("click", this.onButtonClick.bind(this))), this.querySelectorAll(".tab-collage__heading").forEach(e => e.addEventListener("mouseover", this.onButtonClick.bind(this)))
    }
    onButtonClick(e) {
        const t = e.target;
        t.classList.contains("active") || (this.pauseAllMedia(), this.querySelectorAll("[data-block-id]").forEach(e => {
            t.dataset.blockId === e.dataset.blockId ? e.classList.add("active") : e.classList.remove("active")
        }))
    }
    pauseAllMedia() {
        this.querySelectorAll('video-section[data-type="youtube"] iframe').forEach(e => {
            e.contentWindow.postMessage('{"event":"command","func":"pauseVideo","args":""}', "*")
        }), this.querySelectorAll('video-section[data-type="vimeo"] iframe').forEach(e => {
            e.contentWindow.postMessage('{"method":"pause"}', "*")
        })
    }
}
...
class CountdownTimer extends HTMLElement {
    constructor() {
        super(), this.parent = this.closest(".product-countdown"), this.date = new Date(Date.parse(this.dataset.date)).getTime(), isNaN(this.date) && (this.date = new Date(this.dataset.date.replace(/-/g, "/")).getTime(), isNaN(this.date)) ? this.unload() : theme.initWhenVisible({
            element: this,
            callback: this.init.bind(this),
            threshold: 200
        })
    ...
    timer() {
        ...
        n < 0 ? this.unload() : (e = 864e5, t = Math.floor(n / e * 1), i = Math.floor(n % e / 36e5 * 1), s = Math.floor(n % e % 36e5 / 6e4 * 1), n = Math.floor(n % e % 36e5 % 6e4 / 1e3 * 1), "true" == this.dataset.compact ? (e = 0 < t ? `<div class="countdown__item"><span>${t}${dateStrings.d}</span></div>` : "", this.innerHTML = e + `<div class="countdown__item"><span>${9<i?i:"0"+i}:${9<s?s:"0"+s}:${9<n?n:"0"+n}</span></div>`) : (e = 0 < t ? `<div class="countdown__item"><span>${t}</span> ${1==t?dateStrings.day:dateStrings.days}</div>` : "", t = `<div class="countdown__item"><span>${i}</span> ${1==i?dateStrings.hour:dateStrings.hours}</div>`, i = `<div class="countdown__item"><span>${s}</span> ${1==s?dateStrings.minute:dateStrings.minutes}</div>`, s = `<div class="countdown__item"><span>${n}</span> ${1==n?dateStrings.second:dateStrings.seconds}</div>`, this.innerHTML = e + t + i + s))
    }
    unload() {
...
class GMap extends HTMLElement {
    ...
    loadScript() {
        return new Promise((e, t) => {
            ...
            document.body.appendChild(i), i.onload = e, i.onerror = t, i.async = !0, i.src = "https://maps.googleapis.com/maps/api/js?key=" + this.dataset.apiKey
        })
    }
    initMap() {
        (new google.maps.Geocoder).geocode({
            ...
            if (t !== google.maps.GeocoderStatus.OK) Shopify.designMode;
                ...
                e = {
                    ...
                    icon: e
                }), new google.maps.StyledMapType(JSON.parse(this.parentNode.querySelector("[data-gmap-style]").innerHTML)));
                i.mapTypes.set("styled_map", t), i.setMapTypeId("styled_map"), google.maps.event.addDomListener(window, "resize", function() {
...
class RelatedButtons extends HTMLElement {
    constructor() {
        super(), window.addEventListener("scroll", this.checkListener.bind(this)), this.querySelectorAll("a").forEach(e => e.addEventListener("click", this.onButtonClick.bind(this)))
    }
    checkListener() {
        var e = document.querySelector(this.dataset.scrollto);
        window.scrollY >= e.offsetTop - e.clientHeight ? this.classList.add("is-flipped") : this.classList.remove("is-flipped")
    }
    onButtonClick(e) {
        e.preventDefault();
        e = e.target;
...
class ProductRecentlyViewed extends HTMLElement {
    constructor() {
        var e, t, i;
        super(), isStorageSupported("local") && (e = parseInt(this.dataset.productId), t = "beyours:recently-viewed", (i = JSON.parse(window.localStorage.getItem(t) || "[]")).includes(e) || i.unshift(e), window.localStorage.setItem(t, JSON.stringify(i.slice(0, 5))))
    }
}
...
class RecentlyViewedProducts extends HTMLElement {
    ...
    init() {
        fetch(this.dataset.url + this.getQueryString()).then(e => e.text()).then(e => {
    ...
    getQueryString() {
        var e = JSON.parse(window.localStorage.getItem("beyours:recently-viewed") || "[]");
        return this.dataset.productId && e.includes(parseInt(this.dataset.productId)) && e.splice(e.indexOf(parseInt(this.dataset.productId)), 1), e.map(e => "id:" + e).slice(0, 4).join(" OR ")
    }
}
customElements.define("recently-viewed-products", RecentlyViewedProducts);
class VideoSection extends HTMLElement {
    constructor() {
        super(), this.background = "template" !== this.dataset.initMode, this.background ? theme.initWhenVisible({
            element: this,
            callback: this.init.bind(this),
            threshold: 600
        }) : this.init()
    ...
    initMp4Video() {
        ...
        var t;
        e && void 0 !== (t = e.play()) && t.then(function() {}).catch(function() {
    ...
    loadScript(s) {
        return new Promise((e, t) => {
            var i = document.createElement("script");
            document.body.appendChild(i), i.onload = e, i.onerror = t, i.async = !0, i.src = "youtube" === s ? "//www.youtube.com/iframe_api" : "//player.vimeo.com/api/player.js"
        })
    }
    setAsLoading() {
        ...
        const t = this.dataset.videoId,
            i = setInterval(() => {
                window.YT && window.YT.ready(() => {
                    ...
                    this.appendChild(e), this.player = new YT.Player(e, {
                        videoId: t,
                        playerVars: {
                            showinfo: 0,
    ...
    onYoutubeReady() {
        this.iframe = this.querySelector("iframe"), this.iframe.setAttribute("tabindex", "-1"), this.background && this.player.mute(), "function" == typeof this.player.playVideo && this.player.playVideo(), this.setAsLoaded(), new IntersectionObserver((e, t) => {
            e.forEach(e => {
    ...
    youtubePlay() {
        this.background && this.player && "function" == typeof this.player.playVideo && this.player.playVideo()
    }
    youtubePause() {
        this.background && this.player && "function" == typeof this.player.pauseVideo && this.player.pauseVideo()
    }
    setupVimeoPlayer() {
        const e = this.dataset.videoId,
            t = setInterval(() => {
                window.Vimeo && (this.player = new Vimeo.Player(this, {
                    ...
                    height: "100%",
                    width: "100%"
                }), this.player.ready().then(this.onVimeoReady.bind(this)), clearInterval(t))
            }, 50)
    }
    onVimeoReady() {
        this.iframe = this.querySelector("iframe"), this.iframe.setAttribute("tabindex", "-1"), this.background && this.player.setMuted(!0), this.setAsLoaded(), new IntersectionObserver((e, t) => {
            e.forEach(e => {
    ...
    vimeoPlay() {
        this.background && this.player && "function" == typeof this.player.play && this.player.play()
    }
    vimeoPause() {
        this.background && this.player && "function" == typeof this.player.pause && this.player.pause()
    }
}
...
class BundleProduct extends HTMLElement {
    ...
    onSelectChange(e) {
        ...
        this.price.classList.remove(this.classes.souldout), this.price.classList.remove(this.classes.onsale), this.price.classList.remove(this.classes.nocompare), !1 == t ? this.price.classList.add(this.classes.souldout) : s < i && t && this.price.classList.add(this.classes.onsale), 0 == n && e && this.price.classList.add(this.classes.nocompare);
        this.querySelector(".price__regular").querySelector(".price-item--regular").innerHTML = `<price-money><bdi>${theme.Currency.formatMoney(s,shopSettings.moneyFormat)}</bdi></price-money>`;
        t = this.querySelector(".price__sale");
        t.querySelector(".price-item--regular").innerHTML = `<price-money><bdi>${theme.Currency.formatMoney(i,shopSettings.moneyFormat)}</bdi></price-money>`, t.querySelector(".price-item--sale").innerHTML = `<price-money><bdi>${theme.Currency.formatMoney(s,shopSettings.moneyFormat)}</bdi></price-money>`
    }
}
customElements.define("bundle-product", BundleProduct);
class BundleProducts extends HTMLElement {
    constructor() {
        super(), this.miniCart = document.querySelector("mini-cart"), this.button = this.querySelector("button"), this.button && this.button.addEventListener("click", this.onButtonClick.bind(this)), this.blocks = this.querySelectorAll("[data-block-id]"), this.blocks.forEach(e => e.addEventListener("mouseenter", this.onEnterHandler.bind(this))), this.blocks.forEach(e => e.addEventListener("mouseleave", this.onLeaveHandler.bind(this)))
    }
    onEnterHandler(e) {
        ...
        this.blocks.forEach(e => {
            ("BUNDLE-PRODUCT" === t.nodeName && "BUNDLE-PRODUCT" === e.nodeName || e.dataset.blockId === i) && e.classList.add("active")
        })
    }
    onLeaveHandler() {
        this.classList.remove("hovering"), this.blocks.forEach(e => e.classList.remove("active"))
    }
    onButtonClick(e) {
        e.preventDefault();
        var t, e = {
        ...
        document.body.classList.contains("template-cart") || !shopSettings.cartDrawer ? Shopify.postLink2(routes.cart_add_url, {
            parameters: {
                ...e
            }
        }) : (this.handleErrorMessage(), this.button.setAttribute("disabled", !0), this.button.classList.add("loading"), t = this.miniCart ? this.miniCart.getSectionsToRender().map(e => e.id) : [], e = JSON.stringify({
            ...e,
            sections: t,
            sections_url: window.location.pathname
        }), fetch("" + routes.cart_add_url, {
            ...
            e.status ? this.handleErrorMessage(e.description) : this.miniCart && this.miniCart.renderContents(e)
        }).catch(e => {
            console.error(e)
        }).finally(() => {
...
class ShopTheLook extends HTMLElement {
    constructor() {
        super(), 1 != this.dataset.blockCount && theme.initWhenVisible({
            element: this,
            callback: this.init.bind(this),
            threshold: 600
        })
    ...
    init() {
        this.products = this.querySelector(".image-with-text__products"), this.blocks = this.querySelectorAll("lookbook-component [data-block-index]"), this.blocks.forEach(e => e.addEventListener("mouseenter", this.onEnterHandler.bind(this))), this.products.querySelectorAll(".quick-view__summary").forEach(e => e.addEventListener("click", this.onButtonClick.bind(this))), this.initSlider()
    }
    onButtonClick(e) {
        e.preventDefault();
        e = e.target.closest(".product-container"), e = this.querySelector(`lookbook-component [data-block-index="${e.dataset.blockIndex}"]`).closest("summary");
        e && e.click()
    }
    onEnterHandler(e) {
        this.flickity && "function" == typeof this.flickity.select && (e = parseInt(e.target.dataset.blockIndex), this.flickity.select(e))
    }
    onFocusHandler(t) {
        this.blocks.forEach(e => {
            e.classList.remove("focus"), parseInt(e.dataset.blockIndex) === t && e.classList.add("focus")
        })
    }
    initSlider() {
...
class SelectWrapper extends HTMLElement {
    ...
    init() {
        var e = window.getComputedStyle(this.select),
            ...
            e = (i.style.fontFamily = e.fontFamily, i.style.fontSize = e.fontSize, i.style.fontWeight = e.fontWeight, i.style.visibility = "hidden", i.style.position = "absolute", i.innerHTML = t, document.body.appendChild(i), i.clientWidth);
...
class ImageComparison extends HTMLElement {
    constructor() {
        super(), this.active = !1, this.button = this.querySelector("button"), this.horizontal = "horizontal" === this.dataset.layout, this.init(), theme.initWhenVisible({
    ...
    onHandler(e) {
        this.active && (e = e.touches && e.touches[0] || e, e = this.horizontal ? e.pageX - this.offsetLeft : e.pageY - this.offsetTop, this.scrollIt(e))
    }
    scrollIt(e) {
...
class CartSampleProducts extends HTMLElement {
    constructor() {
        super(), this.miniCart = document.querySelector("mini-cart"), this.cartItems = document.querySelector("cart-items");
        const e = this.querySelector(".cart-sample-products"),
            t = this.querySelectorAll(".cart-sample-product"),
            c = Array.from(this.querySelectorAll("div[data-product-id]")).map((e => parseInt(e.dataset.productId))),
        ...
        e && r && i && (r.addEventListener("click", (() => o("prev"))), i.addEventListener("click", (() => o("next")))), 0 === e.scrollLeft && (r && r.setAttribute("disabled", !0)), e.addEventListener("scroll", (() => {
            e.scrollWidth - e.scrollLeft === e.clientWidth && (i.classList.add("hide"), r.classList.remove("hide")), 0 === e.scrollLeft && (r.classList.add("hide"), i.classList.remove("hide"))
        })), t.forEach((e => {
            const t = e.querySelector('input[type="checkbox"]'),
                c = e.dataset.productId;
            t.addEventListener("click", (e => {
                if (e.preventDefault(), c) {
                    if (document.body.classList.contains("template-cart") || !shopSettings.cartDrawer) return void Shopify.postLink(routes.cart_add_url, {
                        parameters: {
                            id: c,
                            quantity: 1
                        }
                    });
                    const e = this.miniCart ? this.miniCart.getSectionsToRender().map((e => e.id)) : [],
                        t = JSON.stringify({
                            id: c,
                            quantity: 1,
                            sections: e,
    ...
    checkforSamples(e, t) {
        ...
        fetch("/cart.js").then((e => e.json())).then((o => {
            const s = o.items;
            s.some((t => e.includes(t.id))) ? t.forEach((e => {
                e.classList.remove("deactive"), e.classList.remove("active"), e.querySelector('input[type="checkbox"]').removeAttribute("disabled")
            })) : t.forEach((e => {
                e.classList.remove("deactive"), e.classList.remove("active"), e.querySelector('input[type="checkbox"]').removeAttribute("disabled"), e.querySelector('input[type="checkbox"]').checked = !1
            })), s.forEach(((t, c) => {
                ...
                i++
            })), i == r && r > 0 && fetch(window.Shopify.routes.root + "cart/clear.js", {
                method: "POST"
            ...
            for (let t = 0; t < i; t++) {
                ...
                if (e.includes(i.id)) {
                    ...
                    t.classList.add("active"), t.classList.remove("deactive"), t.querySelector('input[type="checkbox"]').checked = !0, console.log(i.product_title);
                    const o = t.querySelector('input[type="checkbox"]');
                    if (o.setAttribute("disabled", !0), o.checked = !0, i.quantity > 1) {
                        const t = document.querySelector('[data-variant-id="' + i.id + '"] cart-remove-button').getAttribute("data-index");
            ...
            if (r > 2) {
                const e = JSON.stringify({
                    id: c.pop(),
                    quantity: 0,
                    sections: ["mini-cart", "cart-icon-bubble", "cart-live-region-text"]
                });
...
void 0 === Shopify.getCart && (Shopify.getCart = function(t, o) {
    if (!o) return jQuery.getJSON("/cart.js", (function(o, f, n) {
        "function" == typeof t ? t(o, f, n) : Shopify.onCartUpdate(o)
    }));
    "function" == typeof t ? t(o) : "function" == typeof Shopify.onCartUpdate && Shopify.onCartUpdate(o)
});